...
MAKE_HOOK_NAT(BeatmapLevelSO_GetCoverImageTexture2DAsync, 0x12B1508, void, BeatmapLevelSO self, void* cancellationToken) {
...
MAKE_HOOK_NAT(BeatmapLevelSO_InitData, 0x12B1800, void, BeatmapLevelSO self) {
	log("Called BeatmapLevelSO_InitData Hook!");
	BeatmapLevelSO_InitData(self);
}

MAKE_HOOK_NAT(BeatmapLevelSO_OnEnable, 0x12B1A28, void, BeatmapLevelSO self) {
	log("Called BeatmapLevelSO_OnEnable Hook!");
	BeatmapLevelSO_OnEnable(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_add_didSelectPackEvent, 0x12C0170, void, LevelPacksTableView self, void* value) {
	log("Called LevelPacksTableView_add_didSelectPackEvent Hook!");
	LevelPacksTableView_add_didSelectPackEvent(self, value);
}

MAKE_HOOK_NAT(LevelPacksTableView_remove_didSelectPackEvent, 0x12C027C, void, LevelPacksTableView self, void* value) {
	log("Called LevelPacksTableView_remove_didSelectPackEvent Hook!");
	LevelPacksTableView_remove_didSelectPackEvent(self, value);
}

MAKE_HOOK_NAT(LevelPacksTableView_Init, 0x12C0388, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_Init Hook!");
	LevelPacksTableView_Init(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_SetData, 0x12C0530, void, LevelPacksTableView self, void* packCollection) {
	log("Called LevelPacksTableView_SetData Hook!");
	LevelPacksTableView_SetData(self, packCollection);
}

MAKE_HOOK_NAT(LevelPacksTableView_OnEnable, 0x12C05AC, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_OnEnable Hook!");
	LevelPacksTableView_OnEnable(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_OnDisable, 0x12C0654, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_OnDisable Hook!");
	LevelPacksTableView_OnDisable(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_OnDestroy, 0x12C06FC, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_OnDestroy Hook!");
	LevelPacksTableView_OnDestroy(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_CellSize, 0x12C07B0, float, LevelPacksTableView self) {
	log("Called LevelPacksTableView_CellSize Hook!");
	return LevelPacksTableView_CellSize(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_NumberOfCells, 0x12C07B8, int, LevelPacksTableView self) {
	log("Called LevelPacksTableView_NumberOfCells Hook!");
	return LevelPacksTableView_NumberOfCells(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_CellForIdx, 0x12C08A8, void, LevelPacksTableView self, int idx) {
	log("Called LevelPacksTableView_CellForIdx Hook!");
	return LevelPacksTableView_CellForIdx(self, idx);
}

MAKE_HOOK_NAT(LevelPacksTableView_HandleDidSelectColumnEvent, 0x12C0C14, void, LevelPacksTableView self, void* tableView, int column) {
...
MAKE_HOOK_NAT(LevelPacksTableView_HandleAdditionalContentModelDidInvalidateData, 0x12C0D64, void, LevelPacksTableView self) {
...
MAKE_HOOK_NAT(LevelPacksTableView_CancelAsyncOperations, 0x12C0E54, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_CancelAsyncOperations Hook!");
	LevelPacksTableView_CancelAsyncOperations(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_RefreshPacksAvailability, 0x12C1284, void, LevelPacksTableView self) {
	log("Called LevelPacksTableView_RefreshPacksAvailability Hook!");
	LevelPacksTableView_RefreshPacksAvailability(self);
}

MAKE_HOOK_NAT(LevelPacksTableView_SelectCellWithIdx, 0x12C1748, void, LevelPacksTableView self, int idx) {
	log("Called LevelPacksTableView_SelectCellWithIdx Hook!");
	LevelPacksTableView_SelectCellWithIdx(self, idx);
}

MAKE_HOOK_NAT(TextSegmentedControlCellNew_SelectionDidChange, 0x13636D0, void, TextSegmentedControlCellNew self, void* transitionType) {
...
MAKE_HOOK_NAT(TextSegmentedControlCellNew_HighlightDidChange, 0x13638C4, void, TextSegmentedControlCellNew self, void* transitionType) {
...
MAKE_HOOK_NAT(TextSegmentedControlCellNew_RefreshVisuals, 0x13636D4, void, TextSegmentedControlCellNew self) {
	log("Called TextSegmentedControlCellNew_RefreshVisuals Hook!");
	TextSegmentedControlCellNew_RefreshVisuals(self);
}

MAKE_HOOK_NAT(Toggle_add_didSwitchEvent, 0x1363A70, void, Toggle self, void* value) {
	log("Called Toggle_add_didSwitchEvent Hook!");
	Toggle_add_didSwitchEvent(self, value);
}

MAKE_HOOK_NAT(Toggle_remove_didSwitchEvent, 0x1363B7C, void, Toggle self, void* value) {
	log("Called Toggle_remove_didSwitchEvent Hook!");
	Toggle_remove_didSwitchEvent(self, value);
}

MAKE_HOOK_NAT(Toggle_get_isOn, 0x1363C88, char, Toggle self) {
	log("Called Toggle_get_isOn Hook!");
	return Toggle_get_isOn(self);
}

MAKE_HOOK_NAT(Toggle_set_isOn, 0x1363C90, void, Toggle self, char value) {
	log("Called Toggle_set_isOn Hook!");
	Toggle_set_isOn(self, value);
}

MAKE_HOOK_NAT(Toggle_Start, 0x1363ECC, void, Toggle self) {
	log("Called Toggle_Start Hook!");
	Toggle_Start(self);
}

MAKE_HOOK_NAT(Toggle_InternalToggle, 0x1363F3C, void, Toggle self) {
	log("Called Toggle_InternalToggle Hook!");
	Toggle_InternalToggle(self);
}

MAKE_HOOK_NAT(Toggle_RefreshColors, 0x1363C98, void, Toggle self) {
	log("Called Toggle_RefreshColors Hook!");
	Toggle_RefreshColors(self);
}

MAKE_HOOK_NAT(Toggle_OnPointerClick, 0x1363FE4, void, Toggle self, void* eventData) {
	log("Called Toggle_OnPointerClick Hook!");
	Toggle_OnPointerClick(self, eventData);
}

MAKE_HOOK_NAT(Toggle_OnSubmit, 0x13640D4, void, Toggle self, void* eventData) {
	log("Called Toggle_OnSubmit Hook!");
	Toggle_OnSubmit(self, eventData);
}

MAKE_HOOK_NAT(Toggle_OnPointerEnter, 0x1364198, void, Toggle self, void* eventData) {
	log("Called Toggle_OnPointerEnter Hook!");
	Toggle_OnPointerEnter(self, eventData);
}

MAKE_HOOK_NAT(Toggle_OnPointerExit, 0x13641A4, void, Toggle self, void* eventData) {
